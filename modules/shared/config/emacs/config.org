...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Sean Goller"
    user-mail-address "sean@goller.net")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/sean/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/sean/bin" "/profile/bin" "/Users/sean/.npm-packages/bin" "/Users/sean/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
